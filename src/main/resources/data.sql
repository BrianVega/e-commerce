...
-- Insert into ORDERS
INSERT INTO ORDERS (PK_ORDER_ID, TOTAL_USD, DATE, FK_BILLING_INFORMATION_ID, FK_CUSTOMER_ID, FK_PAYMENT_DETAILS_ID, FK_SHIPPING_INFORMATION_ID, STATUS)
VALUES
    (1, 79.98, '2024-10-15 10:00:00', 1, 1, 1, 1, 'CONFIRMED'),
    (2, 49.99, '2024-10-16 09:00:00', 2, 2, 2, 2, 'SHIPPED');